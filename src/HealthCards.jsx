...
icon: { fontSize: 11, color: "var(--ink-low)" },
  cardTitle: { fontFamily: "var(--mono)", fontSize: 9.5, color: "var(--ink-low)", letterSpacing: ".1em", textTransform: "uppercase" },
  ...
  pending: { fontFamily: "var(--mono)", fontSize: 10, color: "var(--ink-low)", textAlign: "center", padding: "10px 0", lineHeight: 1.5 },
};